...
export function updatePublicContact(businessId, { phone, email, storefrontFaq, bankDetails, storeLocation }) {
  return apiRequest(`/businesses/${businessId}/public-contact`, {
    method: "PATCH",
    body: { phone, email, storefrontFaq, bankDetails, storeLocation },
  });
}
